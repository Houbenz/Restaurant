    ...
    <div id="intro" class="view">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-center h-100">
            ...
            <div class="row text-center text-white d-flex justify-ontent-center">
                ...
                <h5 class="my-5  text-white">Prenez un coup d'oeil à nos riche menus et diverse plâts</h5>
                </div>
            </div>
        </div>
            ...
            <div class="row text-center">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-offset="200" >
                    <img src="pictures/g1487.png" alt="" class="img-fluid" width="128" height="128">
                        ...
                        <p class="text-grey">Ou que vous soyez dans la ville de Constantine nos agents vous atteindrez</p>
                </div>
